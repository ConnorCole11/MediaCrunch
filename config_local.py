...
class Config:
    def __init__(self):
        mediaCrunch_path = '/Users/' + 'ColeFamily/Desktop/MediaCrunch/'

        self.playlist_folder = mediaCrunch_path + 'src/playlist_editor/playlists' # the folder with the playlist text files
